    ...
    themeName: "prism",
    themeColor: "#2563eb",
    botAvatarUrl: "./icons/puppy-doc-avatar.png", // Puppy Doc 사진으로 변경
    audioUrl: null // audioUrl을 null로 설정하여 기본적으로 사용하지 않도록 함
    });
    ...
    const Assistant = () => {
        ...
        const sendMessage = async () => {
            ...
            try {
                await client.sendMessage({ type: 'text', text: input, audioUrl: null }); // 여기에도 audioUrl을 추가
            } catch (error) {
